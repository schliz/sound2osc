> [!NOTE]
> This project is a modernized fork of an open source audio analysis tool.

# sound2osc

**Real-time audio analysis to OSC trigger events** for live entertainment systems.

The sound2osc tool converts live audio signals to trigger events that can be sent as OSC messages. It can reproduce the sound-to-light function for lighting consoles and interactive systems. It can also be remotely controlled by OSC.
